...
const doTask = async (info) => {
  ...
  if (document.querySelector(".ed_page") && data?.specializations) {
    if (data?.specializations[0]?.statistics_files) {
      ...
      images.innerHTML += `<img src=${"http://enrollee.by".concat(
        data.specializations[0].statistics_files
      )}>`;
      console.log(
        images,
        "enrollee.by".concat(data.specializations[0].statistics_files)
      );
    }
  }
  console.log(data);
...
if (frontAddress.concat("/news.html") == window.location.href) {
...
if (localStorage.getItem("location") === "applicant") {
  if (authContainer) {
    if (getWithExpiry("token")) {
        ...
        document
          ...
          .addEventListener("click", () => {
            if (data?.email) {
              ...
              createAlert(
                "Ключ к восстановлению пароля отправлен на Вашу почту"
              );
            } else {
            ...
            if (document.querySelector(".post-filters_main")) {
                ...
                e.addEventListener("click", (event) => {
                  ...
                  if (form.region) {
                    ...
                    if (!prof?.specializations[0]) {
                      ...
                      doTask(
                        institutionID(prof?.specializations[0].institution)
                      );
                    }
                    setEis();
                  }
              ...
              document
                ...
                .addEventListener("click", (e) => {
                  ...
                  let d =
                    document.getElementById("specs").options.selectedIndex;
                  if (specs[0].alias) {
                    doTask(
                      specPost(
                        document
            ...
            if (document.querySelector(".admin-panel")) {
              ...
              const fillInfo = () => {
                ...
                info.innerHTML =
                  ...
                  "</label>" +
                  `<input type='date' id='birth_date'  value='${profileInAdmin.birth_date
                    .split(".")
                    .reverse()
                    .join("-")}' name='birth_date'>` +
                  "</div>" +
                  "<div class='auth-input f f-col'>" +
                  ...
                  "</label>" +
                  `<input type='date' id='emission_date' value='${profileInAdmin.personal_document.emission_date
                    .split(".")
                    .reverse()
                    .join("-")}' name='emission_date'>` +
                  "</div>" +
                  "<div class='auth-input f f-col'>" +
                  ...
                  "</label>" +
                  `<input type='date' id='privilege_emisson_date' value='${profileInAdmin.privilege_document.emission_date
                    .split(".")
                    .reverse()
                    .join("-")}' name='privilege_emisson_date'>` +
                  "</div>" +
                  "<div class='auth-input f f-col'>" +
              ...
              document
                ...
                .addEventListener("click", () => {
                  ...
                  if (Object.entries(profileInAdmin).length >= 1) {
                    ...
                    createAlert(
                      "Введите данные для поиска, что бы подтвердить заявку"
                    );
                  }
                });
            }
            ...
            document
              ...
              .addEventListener("click", (e) => {
                if (i <= 3) {
                  ...
                  document.querySelector(".auth-ed-container").innerHTML +=
                    item;
                ...
                document
                  ...
                  .addEventListener("click", () => {
                    ...
                    if (
                      ...
                      document.getElementById("mom_name").onchange = (
                        event
                      ) => {
                        form[event.target.name] = event.target.value;
                        console.log(form);
